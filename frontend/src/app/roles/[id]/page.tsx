      ...
      <ProtectedLayout>
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-300">Cargando datos del rol...</p>
          </div>
        </div>
      </ProtectedLayout>
    );
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 mb-3">
                          <input
                            ...
                            className="w-5 h-5 bg-slate-600 border-slate-500 text-blue-500 rounded focus:ring-2 focus:ring-blue-500"
                          />
                          <label className="text-base font-semibold text-slate-200 uppercase">
                            📦 {modulo}
                          </label>
                        ...
                        <div className="ml-8 grid grid-cols-1 md:grid-cols-2 gap-2">
                          {permisos.map((permiso) => (
                            <label
                              key={permiso.id}
                              className="flex items-start gap-2 cursor-pointer hover:bg-slate-600/30 p-2 rounded transition-colors"
                            >
                              <input
                                type="checkbox"
                                checked={selectedPermisos.has(permiso.id)}
                                onChange={() => handleTogglePermiso(permiso.id)}
                                className="mt-1 w-4 h-4 bg-slate-600 border-slate-500 text-blue-500 rounded focus:ring-2 focus:ring-blue-500"
                              />
                              <div>
